    ...
    <ul class="purchase-list">
      <li class="purchase-item">
        <div class="purchase-info">
          ...
          <p>Total Pembelian: Rp 500.000</p>
          <p>Status: <span class="purchase-status status-pending">Menunggu Pembayaran</span></p>
        </div>
      </li>
      <li class="purchase-item">
        <div class="purchase-info">
          ...
          <p>Total Pembelian: Rp 750.000</p>
          <p>Status: <span class="purchase-status status-shipped">Dalam Pengiriman</span></p>
        </div>
      </li>
      <li class="purchase-item">
        <div class="purchase-info">
          ...
          <p>Total Pembelian: Rp 1.200.000</p>
          <p>Status: <span class="purchase-status status-delivered">Telah Diterima</span></p>
        </div>
      </li>
      <li class="purchase-item">
        <div class="purchase-info">
          ...
          <p>Total Pembelian: Rp 350.000</p>
          <p>Status: <span class="purchase-status status-cancelled">Dibatalkan</span></p>
        </div>
      </li>
