...
<div class="welcome">
 ...
 <div class="welcome">
  ...
  <h2>Ongkos Pengiriman</h2>
  <form id="shipping-form">
  <label for="destination">Asal:</label>
    <input type="text" id="destination" name="destination" placeholder="Masukkan asal pengiriman" required>
    <label for="destination">Tujuan:</label>
    <input type="text" id="destination" name="destination" placeholder="Masukkan tujuan pengiriman" required>
    <label for="weight">Berat (gram):</label>
    <input type="number" id="weight" name="weight" placeholder="Masukkan berat barang" required>
    <button type="submit">Hitung Ongkos Kirim</button>
  </form>
