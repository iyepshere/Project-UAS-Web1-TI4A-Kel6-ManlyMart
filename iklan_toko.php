...
<center>
  ...
  <form id="advertisement-form">
    <label for="logo">Banner:</label><br>
    <center>
    <img src="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/64bf5996168299.5ea8569a1974c.png" width="200"></center><br>
    <input type="file" id="logo" name="logo" accept="image/*" required>
    <label for="title">Judul:</label>
    <input type="text" id="title" name="title" placeholder="Masukkan judul iklan" required>
    <label for="description">Deskripsi:</label>
    <textarea id="description" name="description" placeholder="Masukkan deskripsi iklan" required></textarea>
    <label for="target-url">Tujuan:</label>
    <input type="url" id="target-url" name="target-url" placeholder="Masukkan URL tujuan iklan" required><br><br>
    <button type="submit">Pasang</button>
  </form>
</div>
    </div>
    </div>
