...
<center>
  ...
  <div class="welcome">
    <div class="container">
  <div class="content">
    <h1>Ulasan Pelanggan</h1><br>
    <ul class="review-list">
      <li class="review-item">
        <div class="product-image">
          <img src="https://www.beautified.co.id/wp-content/uploads/2019/08/66419255_184198822573038_8719197152761984752_n.jpg" alt="Foto Produk 1">
        </div>
        <div>
          <div class="review-title">Sepatu Kulit Trendy</div>
          ...
          <div class="review-description">
            Sepatunya bagus banget, worth it to buy deh pokonya!
            Sehat dan lancar terus ya min :D.
          </div>
        </div>
      </li>
      <li class="review-item">
        <div class="product-image">
          <img src="https://blog.eigeradventure.com/wp-content/uploads/2022/08/DSC02511-1.jpg" alt="Foto Produk 2">
        </div>
        <div>
          <div class="review-title">Kemeja Batik Formal</div>
          <div class="review-details">
            Oleh: Ali Agrem<br>
            Varian: Merah - XL<br>
            Rating: 5/5
          ...
          <div class="review-description">
            Puas belanjan di sini padahal baru sekali beli. Produknya bagus, jahitan rapih, bahan juga adem.
            Mantap, 2 jempol buat seller nya hehehe...
          </div>
        </div>
      </li>
      <li class="review-item">
        <div class="product-image">
          <img src="https://cdn-brilio-net.akamaized.net/news/2021/01/26/199364/1395832-1000xauto-fashion-pria.jpg" alt="Foto Produk 2">
        </div>
        <div>
          <div class="review-title">Humblezing Jacket</div>
          <div class="review-details">
            Oleh: Abdul Rohman<br>
            Varian: Army - L<br>
            Rating: 4/5
          </div>
          <div class="review-description">
      ...
      <!-- Tambahkan ulasan pelanggan lainnya jika diperlukan -->
    </ul>
  </div></div>
</div>
<br>
