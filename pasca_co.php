...
<body>
    ...
    <div class="welcome">
        <div class="container"> 
            <h1>Complete Your Order Now!</h1></div>
            <div class="welcome">
            <div class="container">
                <div class="co">
                <center>
                    ...
                    <h4>Total Amount Payable : Rp 900.000,00 </h4>
                </center>
    </div>
    </div>
    </div>
            <form method="post" id="placeOrder">
                ...
                <center>
                <h6 class="text-center-lead">Select Payment Mode</h6></center>
                <div class="form-group">
                ...
                <br>    
                <div class="checkout">
                        <button class="btn-checkout"><a href="akhir_co.php">Place Order</a></button>
    </div>
            </form>
        </div>
    </div>
