...
<html>
<head>
    <title>Batik Keris - Formal</title>
...
<div class="welcome">
    <section class="content">
        ...
        <img src="https://4.bp.blogspot.com/-bpaSBJdBvlA/VfOLQHhBK0I/AAAAAAAAE7A/pr0fUmhdH6A/s1600/bitebrands%2B-%2Blogo%2Bdistro%2Bmerek%2Blokal%2Bindonesia35.jpg" alt="Logo" class="logo">
        <h1>Batik Keris</h1>
        Online - Pekalongan
        <div class="isiberita">
            <center>
            <img src="https://blog.eigeradventure.com/wp-content/uploads/2022/08/DSC02511-1.jpg" width="500" alt="Gambar Berita 1"><br>
            <h1>"Baju Batik Formal Unik"</h1>
            </center>
            <br>
            <h2>Rp 150.000,00</h2>
            ...
            <label><input type="radio" name="color" value="Putih"> Putih</label>
            <label><input type="radio" name="color" value="Merah"> Merah</label>
            </div>
            ...
            <p>Kondisi : Baru<br>
            <br>
            kemeja batik slimfit premium lapis furing asli solo<br>
            <br>
            Batik Premium<br>
            <br>
            Printed Batik<br>
            <br>
            Bahan Katun Primisima<br>
            <br>
            Sudah Lapis Furing<br>
            <br>
            Jahitan Butik Rapi, Awet & Kuat (bergaransi tanpa ribet)<br>
            <br>
            Adem & Nyaman Dipakai<br>
            <br>
            Segera Order Sebelum Sold Out<br>
            <br>
            Size Chart :<br>
            <br>
            S = Lingkar Dada 100; Panjang Baju 70<br>
            M = Lingkar Dada 104; Panjang Baju 71<br>
            L = Lingkar Dada 108; Panjang Baju 72<br>
            XL = Lingkar Dada 112; Panjang Baju 73<br>
            XXL = Lingkar Dada 116; Panjang Baju 74<br>
            <br>
