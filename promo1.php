...
<body>
    ...
    <section class="content">
        <div class="container">
        <div class="promo">
        <h4>Dapatkan Promo Bulan Juli 2023 Sekarang!!</h4>
            <center>
        <img src="https://www.matahari.com/media/wysiwyg/HP_3BOX_B3_DESK_230714_230720.jpg" alt="Gambar 1">
</center>
</div>
</div>
</div>
...
<section class="content">
        <div class="container">
        <div class="reko-item">
            <img src="https://www.matahari.com/media/catalog/product/c/o/cole-slipper-sandals-peter3-kuning_4812803_1_71291.jpg?optimize=medium&bg-color=255,255,255&fit=bounds&height=379&width=293&canvas=293:379" alt="Gambar promo 1">
        <div class="keterangan">
        <a href="#" ><h4>Cole Slipper Sandals Men Peter2</h4></a>
            Rp 175.890,00 - 20%<br>
            <p class="coret">Rp 219.900,00</p>
            <br>
            150 Terjual
            <p>Bandung</p>
        </div>    
        ...
        <div class="reko-item">
            <img src="https://lzd-img-global.slatic.net/g/p/1af982e202e19a6df12e2644ef655179.jpg_360x360q75.jpg_.webp" alt="Gambar promo 2">
            <div class="keterangan">
            <a href="#" ><h4>Kaos Polos Terbaru 2023</h4></a>
            Rp 67.890,00 - 35%<br>
            <p class="coret">Rp 93.900,00</p>
           <br>
           2rb Terjual
            <p>Yogyakarta</p>
        </div>
        ...
        <div class="reko-item">
            <img src="https://down-id.img.susercontent.com/file/sg-11134201-22110-x2smugd5stjva0" alt="Gambar promo 3">
            <div class="keterangan">
            <a href="#.php" ><h4>Outer Santai Elegan</h4></a>
            Rp 113.570,00 - 20%<br>
            <p class="coret">Rp 120.900,00</p>
            <br>
            766 Terjual
            <p>Bandung</p>
            </div>
        ...
        <div class="reko-item">
            <img src="https://lzd-img-global.slatic.net/g/p/a71a35e293306d083ac535894fc42018.jpg_720x720q80.jpg" alt="Gambar Reko 5">
            <div class="keterangan">
            <a href="#" ><h4>Sweater Pria Korea</h4></a>
            Rp 130.876,00 - 35%<br>
            <p class="coret">Rp 142.900,00</p>
            <br>
            875 Terjual
            <p>Jakarta</p>
            </div>
        ...
        <div class="reko-item">
            <img src="https://s4.bukalapak.com/img/4356043292/large/Kemeja_pria_murah_X_MAN_Navy___merah_Pakaian_Pria_Korea_Baju.jpg" alt="Gambar Reko 6">
            <div class="keterangan">
            <a href="#.php" ><h4>Kemeja Pria Murah</h4></a>
            Rp 107.570,00 - 20%<br>
            <p class="coret">Rp 114.400,00</p>
            <br>
            478 Terjual
            <p>Bekasi</p>
            </div>
